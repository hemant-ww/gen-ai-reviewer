...
const robot = app => {
  const handlePROpenOrSync = async (context) => {
  ...
  app.webhooks.on("pull_request.opened", handlePROpenOrSync);
  app.webhooks.on("pull_request.synchronize", handlePROpenOrSync);
